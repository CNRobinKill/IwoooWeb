...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","removeformat","formatmatch","autotypeset","customstyle","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","deletecol","insertrow","deleterow","insertparagraphbeforetable","insertcode","pagebreak","gmap","map","insertimage","scrawl","music","snapscreen","emotion","insertvideo","attachment","insertframe","date","time","horizontal","|","wordimage","spechars","blockquote","anchor","template","background","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","print","searchreplace","preview","fullscreen","webapp"]]
